-- ==========================================================================
-- 37_query_hard_case_union_all.sql
-- What it does: Two UNION ALL branches, the first exactly CORE_B's join
--   graph and predicates -- a documented open question about whether a
--   UNION is one identity or one per branch.
