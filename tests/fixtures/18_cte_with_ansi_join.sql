-- ==========================================================================
-- 18_cte_with_ansi_join.sql
-- What it does: A CTE whose own body is a JOIN, then referenced from an
--   outer ANSI JOIN -- exercises the CTE-body and JOIN left-recursion
--   grammar fixes together in a single statement.
-- Modules: parsing/statement_driver.py, references/table_scan.py,
--   references/relations.py, split/select_blocks.py
-- ==========================================================================
