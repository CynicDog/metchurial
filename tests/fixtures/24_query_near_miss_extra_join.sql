-- ==========================================================================
-- 24_query_near_miss_extra_join.sql
-- What it does: CORE_A plus one extra JOIN nothing depends on -- a near
--   miss: the join graph changed, so a different core_id, but similarity
--   must stay high.
-- Modules: references/query_identity.py (core_id and compute_similarity),
--   references/table_scan.py, references/relations.py
-- ==========================================================================
