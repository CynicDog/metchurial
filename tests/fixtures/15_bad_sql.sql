-- ==========================================================================
-- 15_bad_sql.sql
-- What it does: Deliberately malformed content for the bad-files workflow:
--   bracketed section markers, numbered prose headers, a decorative divider
--   line and a truncated CTE, all sitting outside any comment.
-- Modules: detect/bad_file_check.py, quarantine/bad_files.py
-- ==========================================================================
