-- ==========================================================================
-- 21_query_identity_alias_variant.sql
-- What it does: CORE_A with every correlation name renamed and the SELECT
--   list reordered; alias normalisation must still land it on CORE_A.
