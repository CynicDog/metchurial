-- ==========================================================================
-- 34_query_identity_core_b_base.sql
-- What it does: Base query for CORE_B, a second cluster sharing no tables
--   with CORE_A -- proves multiple genuine clusters are distinguished
--   within one scan.
