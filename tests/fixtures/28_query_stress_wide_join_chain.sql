-- ==========================================================================
-- 28_query_stress_wide_join_chain.sql
-- What it does: A nine-table ANSI JOIN chain, each table contributing its
--   own predicate: join-graph and predicate extraction at enterprise
--   reporting scale.
