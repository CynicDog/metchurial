-- ==========================================================================
-- 14_complex_multi_cte_query.sql
-- What it does: A large real-shaped multi-CTE report query with Korean
--   identifiers. It is one statement, so exactly one SELECT block, and
--   healthy enough that the bad-file pre-check must leave it alone.
-- Modules: split/select_blocks.py, detect/bad_file_check.py,
--   parsing/statement_driver.py, references/table_scan.py
-- ==========================================================================
