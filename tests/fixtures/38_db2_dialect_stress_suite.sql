-- ==========================================================================
-- 38_db2_dialect_stress_suite.sql
-- What it does: A long DB2-dialect stress corpus: system catalog lineage,
--   implicit and explicit joins, multi-CTE graphs, window functions,
--   lateral joins and dialect-specific scalar functions. Sectioned as
--   MODULE 1..n below.
-- Modules: parsing/statement_driver.py, references/table_scan.py,
--   references/relations.py, references/function_visitor.py,
--   references/query_identity.py
-- ==========================================================================
