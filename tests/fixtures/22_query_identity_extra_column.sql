-- ==========================================================================
-- 22_query_identity_extra_column.sql
-- What it does: CORE_A plus one extra projected column. core_id never reads
--   the SELECT list, so this must still land on CORE_A.
