-- ==========================================================================
-- 33_query_hard_case_subquery_rewrite.sql
-- What it does: CORE_A with one relationship rewritten as a correlated
--   EXISTS, so no join edge for it exists in the tree -- a documented non-
--   goal for a purely structural signature.
