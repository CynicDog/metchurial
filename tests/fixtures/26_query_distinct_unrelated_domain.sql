-- ==========================================================================
-- 26_query_distinct_unrelated_domain.sql
-- What it does: A negative control sharing zero tables with either CORE_A
--   or CORE_B; it must score low similarity against both.
