...
-- What it does: CORE_A with one join changed from LEFT OUTER to INNER -- a
--   near miss: join type is part of edge identity, so a different core_id
--   but very high similarity.
