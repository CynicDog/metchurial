-- ==========================================================================
-- 30_query_identity_comma_join_variant.sql
-- What it does: CORE_A with one JOIN rewritten as an old-style comma join
--   and its condition moved into WHERE; both forms yield the same edge, so
--   it must land on CORE_A.
