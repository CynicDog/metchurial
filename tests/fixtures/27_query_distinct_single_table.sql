-- ==========================================================================
-- 27_query_distinct_single_table.sql
-- What it does: A trivial single-table query with no join graph at all --
--   the degenerate case an empty edge set must still hash and score
--   consistently.
