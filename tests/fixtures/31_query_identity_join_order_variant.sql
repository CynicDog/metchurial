-- ==========================================================================
-- 31_query_identity_join_order_variant.sql
-- What it does: CORE_A with the FROM-clause table order permuted; the edge
--   set must be canonicalised before hashing, so it must still land on
--   CORE_A.
