-- ==========================================================================
-- 29_query_stress_multi_cte_join.sql
-- What it does: Four CTEs, each its own multi-table JOIN, consumed by an
--   outer query that joins the CTEs together -- extraction across nested
--   query-block scopes, each with its own alias map.
-- Modules: references/query_identity.py, references/table_scan.py,
--   references/relations.py, parsing/statement_driver.py
-- ==========================================================================
