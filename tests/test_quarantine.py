...
file-moving logic, plus the CLI wiring: it runs automatically on every
scan (not behind a flag), moving every non-matching-extension file to
_quarantine/excluded/ and writing quarantine_manifest.tsv.
...
class TestQuarantineCLI(unittest.TestCase):
    ...
    def test_runs_automatically_moves_non_matching_and_writes_manifest(self):
