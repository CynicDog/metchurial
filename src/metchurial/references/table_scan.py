...
engine.py's pre_chunk_hook) both exclude `is_cte` refs.
...
# parsing/statement_starts.py can reuse them for CTE-prologue validation
# without parsing/ importing from references/. Re-exported via __all__
# above -- this module is still their primary consumer.
