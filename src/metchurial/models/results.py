...
class TreeScanResult:
    ...
    `inferred_boundaries` sums every statement boundary across the tree
    that parsing/statement_starts.py inferred instead of reading off a
    real top-level ';' -- 0 for a conventionally punctuated tree."""
