...
def classify_predicate(ctx: Db2Parser.PredicateContext) -> str | None:
...
def subject_expression(ctx: Db2Parser.PredicateContext, op: str) -> Db2Parser.ExpressionContext | None:
